...
2. Our training data can be downloaded from [UMOE-Speech-453k.json]([url](https://huggingface.co/datasets/Uni-MoE/Uni-MoE-Training-Dataset/blob/main/Uni_MoE_Speech.json)) and [UMOE-Cap-453k.json]([url](https://huggingface.co/datasets/Uni-MoE/Uni-MoE-Training-Dataset/blob/main/Uni_MoE_Cap.json)).
