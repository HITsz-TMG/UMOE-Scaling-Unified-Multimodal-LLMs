import os 
import sys 
root_path = os.path.abspath("/path/to/UMOE") 
...
from umoe_audio.mm_utils import tokenizer_image_audio_video_token
from umoe_audio.model.all_builder import load_all_pretrained_model
...
def inf():
    model_path = "checkpoints/UMOE-audio-e2"
    model_base = "checkpoints/UMOE-audio-base"
    model_name = "umoe_lora"
