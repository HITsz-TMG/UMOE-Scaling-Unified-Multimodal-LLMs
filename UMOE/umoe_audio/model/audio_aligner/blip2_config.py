...
class Blip2Config(PretrainedConfig):
    ...
    def __init__(self, vision_config=None, qformer_config=None, text_config=None, num_query_tokens=32, **kwargs):
        ...
        if text_model_type not in CONFIG_MAPPING:
            if text_model_type == "chatglm":
                self.text_config = AutoConfig.from_pretrained("/UNICOMFS/hitsz_mzhang_1/jsy/model/global_step3000", trust_remote_code = True)
        else:
        ...
        else: self.use_decoder_only_language_model = self.text_config.model_type in MODEL_FOR_CAUSAL_LM_MAPPING_NAMES
