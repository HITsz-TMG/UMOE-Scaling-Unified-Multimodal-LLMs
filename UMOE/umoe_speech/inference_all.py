...
from umoe_speech import conversation as conversation_lib
from umoe_speech.model import *
from umoe_speech.mm_utils import tokenizer_image_token,tokenizer_image_audio_token,tokenizer_image_audio_video_token
from umoe_speech.model.all_builder import load_all_pretrained_model
...
def inf():
    model_path = "checkpoints/UMOE-speech-e2"
    model_base = "checkpoints/UMOE-speech-base"
