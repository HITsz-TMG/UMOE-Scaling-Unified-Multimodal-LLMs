...
from umoe_speech.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def load_all_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", vison_tower_path = None, audio_tower_path = None):
    ...
    if 'umoe' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            print('Loading UMOE from base model...')
            ...
            print('Loading additional UMOE weights...')
