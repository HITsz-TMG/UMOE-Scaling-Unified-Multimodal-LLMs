...
deepspeed --num_gpus 1 --num_nodes 1\
    ...
    umoe_speech/train/train_mem_speech.py \
    --deepspeed ./scripts/zero2.json \
    --model_name_or_path checkpoints/UMOE-speech-base \
    ...
    --bf16 True \
    --output_dir output/UMOE_speech_ckpt \
    --num_train_epochs 2 \
    ...
    --pretrain_mm_mlp_adapter checkpoints/UMOE-speech-base/mm_projector.bin\
    --tune_mm_audio_projector True\
    --pretrain_audio_aligner checkpoints/UMOE-speech-base/mm_audio_aligner.bin\
